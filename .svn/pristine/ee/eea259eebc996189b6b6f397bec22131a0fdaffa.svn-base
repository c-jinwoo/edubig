...
function fnCourseView(mtScCode){
    ...
    $('form[name=frm]').attr('target', '_self').attr('action', '<c:out value="${ctx}"/>/academy/course/offDetail.do?ref1=LON').submit();
}
</script>
...
<div class="container" id="Subcontent">
    <article class="subArea">
        <div class="subCntWrap">
	        ...
	        <section>
             	<div class="bluelineTabWrap">
                  	<ul class="bluelineTab">
						...
						<li class="<c:if test="${REQUEST_DATA.tabNo == 1}"> active</c:if>"><a href="#none" onclick="fnTab('/academy/course/on_off_categoryList.do', '1'); return false;">집합교육</a></li>
			...
			<c:forEach items="${resultList2}" var="result" varStatus="stat">
