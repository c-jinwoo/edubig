...
%>
		...
		-->
		<input type=hidden name=ini_encfield value="<c:out value="${REQUEST_DATA.ini_encfield}"/>"/>
		<input type=hidden name=ini_certid value="<c:out value="${REQUEST_DATA.ini_certid}"/>"/>
		...
		<input type="hidden" name="buyername" value="<c:out value="${REQUEST_DATA.SES_USERNAME}"/>"/>	
		<input type="hidden" name="buyeremail" value="<c:out value="${REQUEST_DATA.SES_EMAIL}"/>"/>
		<input type="hidden" name="buyertel" value="<c:out value="${REQUEST_DATA.SES_MOBILE}"/>"/>	
