				...
				if(isOnProgress){
					...
					$.ajax({
			    		...
			    		success : function(data) {
							...
							$("#shop_receive_url").val(_url+"/payment/receive.do");
...
<body>
	...
	<div id="container">
		<div class="con_center">
			...
			<div id="content">	
				<div class="cont_body">
   					<form name="fm"  method=POST action="/payment/approve.do">
						...
						<input type="hidden" id="shop_receive_url" name="shop_receive_url" value="">
						...
						<div class="wrapper">						
							...
							<c:if test="${empty bookList}">
								<input type="hidden" id="pReceiptNm" name="pReceiptNm" value="<c:out value='${userInfo.MBERNM}'/>"/>
								<input type="hidden" id="pAddr1" name="pAddr1" value="<c:out value='${userInfo.LNM_ADRES1}'/>"/>
								<input type="hidden" id="pAddr2" name="pAddr2" value="<c:out value='${userInfo.LNM_ADRES2}'/>"/>
								<input type="hidden" id="pZip" name="pZip" value="<c:out value='${userInfo.LNM_ZIP}'/>"/>	
								<input type="hidden" id="mobile1" name="mobile1" value="<c:out value='${userInfo.MOBLPHON1}'/>"/>	
								<input type="hidden" id="mobile2" name="mobile2" value="<c:out value='${userInfo.MOBLPHON2}'/>"/>	
								<input type="hidden" id="mobile3" name="mobile3" value="<c:out value='${userInfo.MOBLPHON3}'/>"/>	
							</c:if>
							<div class="c_section" style="margin-top:50px;">
							...
							<div class="c_btn_center">
								...
								<button type="button" class="btn_blueline03" onclick="history.back(); return false;" title="목록">뒤로가기</button>				
							</div>	
						</div>
					</div>	
				</div>			
