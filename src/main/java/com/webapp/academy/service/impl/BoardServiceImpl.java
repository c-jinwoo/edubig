...
public class BoardServiceImpl implements BoardService {
    ...
    public Integer getLateBoardNoEvent(Integer bcateno) throws Exception {
    	return boardMapper.getLateBoardNoEvent(bcateno);
    }
     ...
     * @throws Exception
     */
    public EduMap getBargainInfo() throws Exception{
        return boardMapper.getBargainInfo();
    }
