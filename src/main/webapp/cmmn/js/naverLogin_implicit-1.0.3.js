 ...
 */
	...
	this.get_naver_reprompt = function() {
		var url = "https://nid.naver.com/oauth2.0/authorize?response_type=code&auth_type=reprompt&client_id="+this.client_id+"&redirect_uri=http://www.cslabs.co.kr:7070/member/redirectRepromt.do&state="+this.state;
