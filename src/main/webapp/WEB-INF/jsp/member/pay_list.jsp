					...
					<form name="frm" id="frm" action="/user/payList.do" method="post">
						<div class="c_search_section" style="margin-top:50px;">
							<fieldset>
								...
								<select name="search_code" id="search_code" class="select_child1" style="width:100px;" onchange="searchList();">
									...
									<c:if test="${code eq 'TT0002'}">
										<table>		
											...
											<tbody>
												...
												<c:if test="${empty result}">
													<tr>
														<td colspan="7" class="align_center">결제 내역이 없습니다.</td>
													</tr>
												</c:if>
											</tbody>
										</table>
